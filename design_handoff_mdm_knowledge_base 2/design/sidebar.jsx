      ...
      <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
        ...
        <div style={{ padding: '14px 14px 10px', display: 'flex', alignItems: 'center', gap: 10 }}>
          <div style={{
            ...
            flexShrink: 0,
            boxShadow: '0 1px 0 rgba(15,22,36,0.06), 0 4px 14px -4px oklch(0.50 0.14 252 / 0.45)',
          }}>
            <SidecarMark size={22} color="white" accent="oklch(0.85 0.04 252)"/>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.2, gap: 2 }}>
            <SidecarWordmark size={15} color="var(--fg)" accent="var(--accent)"/>
            <span style={{
