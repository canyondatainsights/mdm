...
const App = () => (
  <DesignCanvas>
    ...
    {/* ============ INTRO ============ */}
    <DCSection id="intro" title="04 · Bubble — deep dive" subtitle="Exploring typeface, mark variations, and color systems for the chosen direction">
      <DCArtboard id="hero" label="Current pick · for reference" width={1080} height={300}>
        <Frame bg={DEFAULT_P.cream} pad={40}>
          <TagChip>BASELINE · CORAL · MANROPE · DEFAULT</TagChip>
          <div style={{ flex:1, display:'flex', alignItems:'center', justifyContent:'center', gap: 32 }}>
            <BubbleDefault size={140}/>
            <div style={{ display:'flex', flexDirection:'column', gap: 10 }}>
              <Wordmark size={80}/>
              <Slogan size={18} variant="fetch"/>
            </div>
          </div>
        </Frame>
      </DCArtboard>
